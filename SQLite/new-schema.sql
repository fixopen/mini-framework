...
(NULL, NULL, 148, 4, 'factory_id', '承制单位id', 0, 78, 0, NULL, NULL, '{"value": "id", "show": "name", "filter": "\"type\" = 1"}'),
(NULL, NULL, 148, 5, 'user_id', '接装单位id', 1, 78, 0, NULL, NULL, '{"value": "id", "show": "name", "filter": "\"type\" = 2"}'),
