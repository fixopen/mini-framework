...
namespace utils::SqlData {
    ...
    namespace {
        ...
        std::map<std::wstring, std::vector<ColumnMeta>> const TABLE_METAS{
                ...
                { L"restrictions", { { L"id", ColumnMeta::INTEGER }, { L"template_id", ColumnMeta::INTEGER }, { L"length", ColumnMeta::INTEGER }, { L"format", ColumnMeta::TEXT }, { L"precision", ColumnMeta::INTEGER }, { L"min", ColumnMeta::REAL }, { L"max", ColumnMeta::REAL } } },
