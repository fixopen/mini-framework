...
namespace utils::SqlData {
    ...
    namespace {
        ...
        std::map<std::wstring, std::vector<ColumnMeta>> const TABLE_METAS{
                ...
                { L"restrictions", { { L"id", ColumnMeta::INTEGER }, { L"template_id", ColumnMeta::INTEGER }, { L"length", ColumnMeta::INTEGER }, { L"format", ColumnMeta::INTEGER }, { L"precision", ColumnMeta::INTEGER }, { L"min", ColumnMeta::REAL }, { L"max", ColumnMeta::REAL } } },
                ...
                { L"info_configs", { { L"id", ColumnMeta::INTEGER }, { L"template_id", ColumnMeta::INTEGER }, { L"parent_id", ColumnMeta::INTEGER }, { L"type", ColumnMeta::INTEGER }, { L"no", ColumnMeta::INTEGER }, { L"name", ColumnMeta::TEXT }, { L"type_no", ColumnMeta::INTEGER }, { L"reference_to", ColumnMeta::INTEGER }, { L"is_required", ColumnMeta::INTEGER }, { L"restriction_id", ColumnMeta::INTEGER }, { L"unit_id", ColumnMeta::INTEGER }, { L"description", ColumnMeta::TEXT } } },
