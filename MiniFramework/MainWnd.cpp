...
void CMainWnd::InitWindow() {
    ...
    // pWeb = static_cast<CWkeWebkitUI*>(m_pm.FindControl(_T("wkeTest")));
    m_pBrowserTabBody = static_cast<CTabLayoutUI*>(m_pm.FindControl(_T("browser_tabbody")));
    pWeb = new CWkeWebkitUI();
    ...
    sHomePage = _T("file:///C:/Users/fixop/source/repos/飛機/productmanage/db-test.html");
    sHomePage = _T("file:///C:/Users/fixop/source/repos/飛機/productmanage/mini.html");
...
void CMainWnd::OnClick(TNotifyUI& msg) {
    ...
    if (msg.pSender == m_pCloseBtn) {
        ...
        m_pRestoreBtn->SetVisible();
        SendMessage(WM_SYSCOMMAND, SC_MAXIMIZE, 0); return;
    } else if (msg.pSender == m_pRestoreBtn) {
        m_pMaxBtn->SetVisible();
...
LPCTSTR CMainWnd::OnJS2Native(CWkeWebkitUI* pWeb, LPCTSTR lpMethod, LPCTSTR lpContent, void* pListenObj) {
    ...
    if (strMethod.CompareNoCase(_T("close")) == 0) {
        ...
        // 创建起始页
        // FIXME remove it CreateNewTabAndGo(sHomePage);
    }
    return lpMethod;
}
