...
void CBrowserTabUI::DoInit() {
    ...
    //标签 HorLayout  ==  OptionUI + 关闭按钮
    this->ApplyAttributeList(_T("maxwidth=\"174\" name=\"browser_tabbar\" "));

    //在标签HorLayout 上增加 OptionUI 和 关闭按钮
    this->Add(m_pOption);
    this->Add(m_pCloseBtn);
    this->Add(m_pIcon);
    m_pOption->ApplyAttributeList(_T(" float=\"true\" ")\
        _T("group=\"group1\" text=\"�±�ǩҳ\" name=\"browseroption\" pos=\"0,0,174,32\" endellipsis=\"true\" textpadding=\"50,0,50,0\"  text=\"�±�ǩҳ\" maxwidth=\"174\" height=\"30\" normalimage=\"file=\'imgs/tabitem.png\' dest = \'0,0,174,32\' source=\'0,0,174,32\'\" hotimage=\"file=\'imgs/tabitem.png\' source=\'174,0,348,32\'\" pushedimage=\"file=\'imgs/tabitem.png\' source=\'348,0,522,32\'\" selectedimage=\"file=\'imgs/tabitem.png\' source=\'348,0,522,32\'\" align=\"center\" "));

    m_pCloseBtn->ApplyAttributeList(
            _T("float=\"true\" pos=\"150, 12, 172, 24\" name=\"btn_tabclose\" normalimage=\"file = \'imgs/tab_close.png\' dest = \'0,0,12,12\' source = \'0,0,12,12\'\" hotimage=\"file = \'imgs/tab_close.png\' dest = \'0,0,12,12\' source = \'12,0,24,12\'\" pushedimage=\"file =\'imgs/tab_close.png\' dest = \'0,0,12,12\' source = \'24,0,36,12\'\""));

    m_pIcon->ApplyAttributeList(
            _T("float=\"true\" pos=\"20,8,40,28\" mouse=\"false\" normalimage=\"file = \'imgs/logo-old.png\' dest = \'0,0,20,20\' \""));
